...
(X[0-9] )?([\w\.\- ]+) \( ([\w\. ]+) \) Vs ([\w\.\- ]+) \( ([\w\. ]+) \) (SF5|SFV|SF4) 1080p|720p - 60fps
(X[0-9] )?([\w\.\- ]+) \( ([\w\. ]+) \) Vs ([\w\.\- ]+) \( ([\w\. ]+) \) ((SF5|SFV|SF4) )?1080p|720p - 60fps
(X[0-9] )?([\w\.\- ]+) \( ([\w\. ]+) \) Vs ([\w\.\- ]+) \( ([\w\. ]+) \) (SF5|SFV|USF4|Arcade Edition 2012|Arcade Edition|SF3) 1080p|720p
*/
var REGEX_YOGAFLAME = /(X[0-9] )?([\w\.\- ]+) \( ([\w\. ]+) \) Vs ([\w\.\- ]+) \( ([\w\. ]+) \) (SF5|SFV|USF4|Arcade Edition 2012|Arcade Edition|SF3) 1080p|720p/;
